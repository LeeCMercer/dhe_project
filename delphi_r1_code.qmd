...
ggplot(gender_counts, aes(x = gen_grp, y = Count)) +
  geom_bar(stat = "identity") +
  coord_flip() +  # Flips the chart to horizontal
  labs(title = "Demographic Distribution by Gender Group", x = "Gender Group", y = "Count") +
...
ggplot(gender_counts, aes(x = eth_grp, y = Count)) +
  geom_bar(stat = "identity") +
  coord_flip() +  # Flips the chart to horizontal
  labs(title = "Demographic Distribution by Ethnic Group", x = "Ethnic Group", y = "Count") +
  scale_y_continuous(breaks = seq(0, max(gender_counts$Count), by = 1)) +  # Set y-axis to display whole numbers
  theme_minimal()
```
...
# Step 2: Create the horizontal bar chart with whole number labels on the y-axis
ggplot(gender_counts, aes(x = edu_att, y = Count)) +
  geom_bar(stat = "identity") +
  coord_flip() +  # Flips the chart to horizontal
  labs(title = "Demographic Distribution by Educational Attainment", x = "Educational Attainment", y = "Count") +
  scale_y_continuous(breaks = seq(0, max(gender_counts$Count), by = 1)) +  # Set y-axis to display whole numbers
  theme_minimal()
```
...
ggplot(gender_counts, aes(x = emp_sec, y = Count)) +
  geom_bar(stat = "identity") +
  coord_flip() +  # Flips the chart to horizontal
  labs(title = "Demographic Distribution by Employment Type", x = "Employment Type", y = "Count") +
  scale_y_continuous(breaks = seq(0, max(gender_counts$Count), by = 1)) +  # Set y-axis to display whole numbers
  theme_minimal()
```
...
#### Sub-construct 1: Digital Skills
...
#### Sub-construct 2: Digital Health Literacy
...
#### Sub construct 3: Digital Self-Efficacy
...
#### Sub construct 4: Socio-Digital Norms
...
#### Sub construct 5: Digital Outcome Expectancy
...
#### Sub construct 7: Digital Behavioural Regulation
...
## 2.Non-response Bias Check (Mann-Whitney U Test)
...
## 3. Round 1 Analysis: Consensus Measurement

::: callout-note
Purpose Assess the level of agreement among experts on the relevance of each item.
:::
...
## 4. Qualitative Analysis (Content and Syntax)
...
::: callout-note
**Purpose** Refine the measurement tool based on Round 1 analysis.
:::
...
## 6. Post-hoc Comparisons (Optional)

::: callout-note
Purpose: Explore subgroup differences (e.g., academics vs. public health professionals) to determine if different groups hold varying views on item relevance.
:::
